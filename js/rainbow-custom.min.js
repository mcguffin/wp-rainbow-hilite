...
b.push(c);return b.sort(function(a,b){return b-a})}function z(a,b,c){function e(b,n){n<b.length?v(b[n].pattern,b[n],a,function(){e(b,++n)}):G(a,function(a){delete k[d];delete f[d];--d;c(a)})}++d;e(b,0)}function G(a,b){function c(a,b,e,f){if(e<b.length){++A;var l=b[e],m=k[d][l];a=a.substr(0,l)+a.substr(l).replace(m.replace,m["with"]);l=function(){c(a,b,++e,f)};0<A%250?l():setTimeout(l,0)}else f(a)}var e=y(k[d]);c(a,e,0,b)}function q(a,b,c){var e=p[b]||[],h=p[B]||[];b=C[b]?e:e.concat(h);z(a.replace(/</g,
"&lt;").replace(/>/g,"&gt;").replace(/&(?![\w\#]+;)/g,"&amp;"),b,c)}function r(a,b,c){if(b<a.length){var e=a[b],h=E(e);return-1<(" "+e.className+" ").indexOf(" rainbow ")||!h?r(a,++b,c):(h=h.toLowerCase(),e.className+=e.className?" rainbow":"rainbow",q(e.innerHTML,h,function(d){e.innerHTML=d;k={};f={};s&&s(e,h);setTimeout(function(){r(a,++b,c)},0)}))}c&&c()}function D(a,b){a=a&&"function"==typeof a.getElementsByTagName?a:document;var c=a.getElementsByTagName("pre"),e=a.getElementsByTagName("code"),
d,f=[],g=[];for(d=0;d<c.length;++d)c[d].getElementsByTagName("code").length?c[d].innerHTML=c[d].innerHTML.replace(/^\s+/,"").replace(/\s+$/,""):f.push(c[d]);for(d=0;d<e.length;++d)g.push(e[d]);r(g.concat(f),0,b)}var k={},f={},p={},C={},d=0,B=0,w=0,A=0,m,s;return{extend:function(a,b,c){1==arguments.length&&(b=a,a=B);C[a]=c;p[a]=b.concat(p[a]||[])},b:function(a){s=a},a:function(a){m=a},color:function(a,b,c){if("string"==typeof a)return q(a,b,c);if("function"==typeof a)return D(0,a);D(a,b)}}}();
document.onreadystatechange=function(){"complete"===document.readyState&&Rainbow.color()};Rainbow.onHighlight=Rainbow.b;Rainbow.addClass=Rainbow.a;Rainbow.extend("c",[{name:"meta.preprocessor",matches:{1:[{matches:{1:"keyword.define",2:"entity.name"},pattern:/(\w+)\s(\w+)\b/g},{name:"keyword.define",pattern:/endif/g},{name:"constant.numeric",pattern:/\d+/g},{matches:{1:"keyword.include",2:"string"},pattern:/(include)\s(.*?)$/g}]},pattern:/\#([\S\s]*?)$/gm},{name:"keyword",pattern:/\b(do|goto|typedef)\b/g},{name:"entity.label",pattern:/\w+:/g},{matches:{1:"storage.type",3:"storage.type",4:"entity.name.function"},pattern:/\b((un)?signed|const)? ?(void|char|short|int|long|float|double)\*? +((\w+)(?= ?\())?/g},
