tinymce.PluginManager.add("wprainbow",function(b){function e(){var a=b.dom.getParent(b.selection.getNode(),"PRE");d.disabled(!a);d.value(b.dom.getAttrib(a,"data-language"));f.disabled(!a)}function g(a){b.dom.setAttrib(b.dom.getParent(b.selection.getNode(),"PRE"),"data-language",a)}function h(){var a=b.dom.getParent(b.selection.getNode(),"PRE"),c=b.dom.getAttrib(a,"data-language"),a=b.dom.getAttrib(a,"data-line")||0;b.windowManager.open({title:wprainbow.l10n.code_properties,body:[{type:"listbox",name:"language",
