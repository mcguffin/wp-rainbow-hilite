...
class Plugin extends Singleton implements ComponentInterface {
	...
	private $plugin_prefix = 'wp_rainbow_hilite';
	...
	public function version() {
		try {
			...
			return get_site_option( 'wp_rainbow_hilite_version' );
		}
	...
	public function maybe_upgrade() {
		...
		$old_version = get_site_option( 'wp_rainbow_hilite_version' );
		...
		if ( version_compare($new_version, $old_version, '>' ) ) {
			...
			update_site_option( 'wp_rainbow_hilite_version', $new_version );
